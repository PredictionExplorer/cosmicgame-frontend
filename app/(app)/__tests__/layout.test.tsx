...
import { metadata as landingMetadata, viewport as landingViewport } from '../../(landing)/layout';

describe('Root layout metadata (shared by both route groups)', () => {
  it('both root layouts export the same site-wide metadata defaults', () => {
    expect(landingMetadata).toBe(metadata);
