...
jest.mock('@/components/home/experimental/GestureStatus', () => ({
  GestureStatus: (props: Record<string, unknown>) => mockGestureStatus(props),
}));

jest.mock('@/components/home/experimental/GestureForm', () => ({
  GestureForm: ({
    previewMode = false,
    cstGestureData,
...
jest.mock('@/components/home/experimental/AllocationTracksBoard', () => ({
...
jest.mock('@/components/home/experimental/DeckPersonalStrip', () => ({
...
jest.mock('@/components/home/experimental/DeckMiniBar', () => ({
...
jest.mock('@/components/home/experimental/SpecialAllocationRecipients', () => ({
