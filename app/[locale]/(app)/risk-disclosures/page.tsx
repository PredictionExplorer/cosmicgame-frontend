...
// lexicon-allow-start: dedicated risk page must use explicit denial language for crawler and legal clarity
export const metadata: Metadata = createMetadata(
  'Cosmic Signature Risk Disclosures | Not an Investment Product',
  'Read Cosmic Signature risk disclosures covering blockchain participation, wallet interactions, NFTs, CST, allocations, and non-investment language.',
  undefined,
  '/risk-disclosures',
);
    ...
    <main id="main" tabIndex={-1} className="mx-auto max-w-4xl px-6 py-16 lg:py-24">
      <JsonLd
        data={breadcrumbJsonLd([
          { name: 'Home', path: '/' },
          { name: 'Risk Disclosures', path: '/risk-disclosures' },
        ])}
      />
