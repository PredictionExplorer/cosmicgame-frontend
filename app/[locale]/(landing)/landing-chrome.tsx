 ...
 * footer. The (landing) root layout and the global 404
 * (app/global-not-found.tsx) both render it, so an unknown URL on
 * cosmicsignature.com gets the landing's own header and footer, and never
 * the app's wallet stack.
 */
