...
/**
 * HowToPlayPage: A guide explaining how to play the Cosmic Signature game,
...
const HowToPlayPage = () => {
  ...
  return (
    <MainWrapper>
      ...
      <Typography mb={4}>Here are the exact steps to play the Cosmic Signature game.</Typography>
      ...
      <Box mt={8}>
        ...
        <Typography mb={2}>
          ...
          <Link href="https://www.cosmicsignature.com" target="_blank" rel="noopener noreferrer">
        ...
        <Box mb={4}>
          ...
          <img src="/images/screenshot1.png" width="100%" alt="Connecting wallet screenshot" />
        </Box>
      ...
      <Box mt={8}>
        ...
        <Typography mb={2}>Review these 4 fields before placing a bid:</Typography>
        ...
        <Box mb={4}>
          <img src="/images/screenshot2.png" width="100%" alt="Round timer screenshot" />
        </Box>
        ...
        <Box mb={4}>
          <img src="/images/screenshot3.png" width="100%" alt="Bid price screenshot" />
        </Box>
        ...
        <Box mb={4}>
          <img src="/images/screenshot4.png" width="100%" alt="Main prize reward screenshot" />
        </Box>
        ...
        <Accordion expanded={expanded === 0} onChange={handleChange(0)}>
          ...
          <AccordionDetails>
            ...
            <ul>
              ...
              <li>
                <Typography>A chance to win the Cosmic Signature NFT</Typography>
              </li>
            </ul>
            <Typography mb={2}>
      ...
      <Box mt={8}>
        <Accordion expanded={expanded === 1} onChange={handleChange(1)} sx={{ mt: 8 }}>
          <AccordionSummary expandIcon={<ExpandMoreIcon />}>
          ...
          <AccordionDetails>
            <ul>
              ...
              <li>
                <Typography>You earn 100 CST every time you place a bid.</Typography>
              </li>
              <li>
                <Typography>
      ...
      <Typography mt={8}>
        ...
        <Link href="https://x.com/CosmicSignatureNFT" target="_blank" rel="noopener noreferrer">
