...
import { AnchoredTokensTable } from '../AnchoredTokensTable';

const mockRelease = jest.fn().mockResolvedValue(undefined);
const mockReleaseMany = jest.fn().mockResolvedValue(undefined);
...
describe('AnchoredTokensTable', () => {
  it('renders empty state message', async () => {
    await act(async () => {
      render(
        <AnchoredTokensTable
          list={[]}
          handleUnstake={mockRelease}
          handleUnstakeMany={mockReleaseMany}
          IsRwalk={false}
        />,
      );
    });
