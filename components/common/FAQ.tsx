...
const FAQ = () => {
  const items = [
    ...
    {
      summary: 'How can I trade or sell my Cosmic Signature NFTs or Cosmic Signature Tokens?',
      detail:
    ...
    {
      summary: 'Can I participate in the Cosmic DAO without bidding in the game?',
      detail:
    ...
    {
      summary: 'What controls does the team have over the Cosmic Signature game?',
      detail:
    ...
    {
      summary: 'Does this mean that the number of Cosmic Signature NFTs is limited?',
      detail:
    ...
    {
      summary: 'What impact does limiting the number of Cosmic Signature NFTs have?',
      detail:
    ...
    {
      summary: 'What is the significance of generating NFTs with a random seed?',
      detail:
