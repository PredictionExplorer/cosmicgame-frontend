...
/** Displays elapsed calibration time and duration, or an ended message when the window exceeds its duration. */
export function AuctionInfo({
  secondsElapsed,
  auctionDuration,
  endedMessage = 'Calibration window ended.',
}: AuctionInfoProps) {
  return (
    <div className="ml-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4 items-center">
        <div className="md:col-span-5">
          <p className="text-base font-medium">Calibration duration:</p>
        </div>
        <div className="md:col-span-7">
