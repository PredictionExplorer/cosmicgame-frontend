  ...
  return (
    ...
    >
      <section
        ...
        className="mx-auto flex max-w-4xl items-center justify-between gap-4 liquid-glass-control liquid-glass-static rounded-full border border-white/[0.12] bg-popover/70 px-4 py-2 shadow-[0_24px_80px_-40px_rgb(var(--aurora-cyan-rgb)/0.8)]"
      >
        ...
        {showGestureAction ? (
          <Button
            ...
            className="liquid-glass-cta h-9 shrink-0 rounded-full border-0 px-4 text-xs font-semibold text-primary-foreground"
          >
