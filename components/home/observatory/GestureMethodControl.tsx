 ...
 * the arrow keys move and select, Home and End jump). It is drawn as the
 * system's segmented control: a sunken track whose selected segment sits on
 * the raised surface, edged by the 3:1 control boundary (no --primary rule,
 * so no rule bends around a rounded corner). Each segment shows its price,
 * the thing the control exists to compare, under the method's name; in a
 * narrow panel the segments become rows with the price at the end, so no
 * price or unit ever breaks.
 *
