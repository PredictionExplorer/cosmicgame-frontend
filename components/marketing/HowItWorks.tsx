...
/**
 * How outreach allocations work, in three steps set as hairline columns: a
 * number, a glyph, the step and what it involves, in full (the detail that
 * used to hide behind an info button under each step is part of the text).
