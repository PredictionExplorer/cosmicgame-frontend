...
/*
 * A Signature's published files, derived from its seed. Kept apart from the
 * trait-based alt text in ./signatureArt so a thumbnail can be drawn without
 * shipping the `traits` catalog to the page.
 */
