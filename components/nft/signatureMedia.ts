...
/*
 * A Signature's published media, derived from its seed alone: no hooks and
 * no catalogs, so a page that only shows the art (How it works) does not
 * pull the traits catalog in with the alt-text hook in ./signatureArt.
 */
