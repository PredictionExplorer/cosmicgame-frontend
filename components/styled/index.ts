...
export const FaqAccordion = styled(Accordion)({
  ...
  "&:after": {
    ...
    height: "100%",
    background:
      "linear-gradient(152.14deg, rgba(21, 191, 253, 0.49) 9.96%, rgba(156, 55, 253, 0.49) 100%)",
    WebkitMask:
...
export const VideoCard = styled(StyledCard)({
  position: "relative",
  background:
    "linear-gradient(#080B2A, #080B2A) padding-box, linear-gradient(90deg, rgba(21, 191, 253, 0) 8.19%, rgba(21, 191, 253, 0.7) 70.61%, rgba(156, 55, 253, 0.7) 100%) border-box",
  borderRadius: "16px",
...
export const GradientText = styled(Typography)({
  background:
    "linear-gradient(117.76deg, #35C9FF 3.35%, #1D9BEF 3.35%, #AC56FF 82.8%)",
