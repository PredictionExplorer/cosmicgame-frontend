...
export const StyledCard = styled(Card)(!(isMobile || isFirefox) ? {
  position: "relative",
...
export const StyledCard2 = styled(Card)(!(isMobile || isFirefox) ? {
  position: "relative",
  background: "transparent",
  boxShadow: "none",
  button: {
...
export const NFTImageWrapper = styled(Box)(!(isMobile || isFirefox) ? {
  position: "relative",
  border: 0,
  "--border": "1px",
  "--radius": "8px",
...
export const GradientBorder = styled(Box)(!(isMobile || isFirefox) ? {
  position: "relative",
  border: 0,
  "--border": "1px",
  "--radius": "16px",
...
export const CodeWrapper = styled(Box)(!(isMobile || isFirefox) ? {
  position: "relative",
  border: 0,
  "--border": "1px",
  "--radius": "16px",
