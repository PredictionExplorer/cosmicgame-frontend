...
const RECORD_TYPE_MAP: Record<number, { icon: ReactNode; text: string }> = {
  ...
  2: { icon: <Heart className="h-5 w-5" />, text: 'Main Prize CS NFT' },
  3: { icon: <Trophy className="h-5 w-5" />, text: 'Raffle ETH (for bidders)' },
  4: { icon: <Ticket className="h-5 w-5" />, text: 'Raffle CST (for bidders)' },
  5: { icon: <Layers className="h-5 w-5" />, text: 'Raffle CS NFT (for bidders)' },
  6: { icon: <Layers className="h-5 w-5" />, text: 'Raffle CST (for RandomWalk stakers)' },
  7: { icon: <Trophy className="h-5 w-5" />, text: 'Raffle CS NFT (for RandomWalk stakers)' },
  8: { icon: <Trophy className="h-5 w-5" />, text: 'Endurance Champion CS NFT' },
  ...
  12: { icon: <Ticket className="h-5 w-5" />, text: 'Chrono Warrior CS NFT' },
  13: { icon: <Ticket className="h-5 w-5" />, text: 'Staking Deposit ETH (for CS NFT stakers)' },
  14: { icon: <Ticket className="h-5 w-5" />, text: 'Last CST Bidder CS NFT (ERC721)' },
