...
describe('UniqueStakersCSTTable', () => {
  ...
  it('renders table headers', () => {
    ...
    expect(screen.getAllByText('Total Reward (ETH)').length).toBeGreaterThanOrEqual(1);
    expect(screen.getAllByText('Unclaimed Reward (ETH)').length).toBeGreaterThanOrEqual(1);
  });
