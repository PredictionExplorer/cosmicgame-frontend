  ...
  const categories: FundCategory[] = [
    {
      ...
      tooltip: 'Main ETH prize awarded to the last bidder when the countdown reaches zero.',
    ...
    },
    {
      ...
      tooltip: 'ETH split among random raffle winners drawn from all bidders at round end.',
    ...
    },
    {
      ...
      tooltip: 'Donated to Ethereum Protocol Guild every round.',
    ...
    },
    {
      ...
      tooltip:
        'Awarded to the bidder who held the Endurance Champion title for the longest consecutive period.',
    ...
    },
    {
      ...
      tooltip: 'Remaining funds that roll over into the next round prize pool.',
