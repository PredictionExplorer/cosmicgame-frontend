/** Original atmosphere layers from e58da429; visibility is scoped in liquid-glass-theme.css. */
export function OriginalAmbientBackdrop({ variant }: { variant: 'subtle' | 'signature' | 'hero' }) {
  return (
    <div data-original-ambient={variant} className="absolute inset-0">
