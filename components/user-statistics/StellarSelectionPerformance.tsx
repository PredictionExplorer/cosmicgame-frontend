...
export interface StellarSelectionPerformanceProps {
...
export function StellarSelectionPerformance({
  userInfo,
  ...
  }, [data, stellarSelectionETHProbability]);

  const totalStellarSelectionEth =
