...
} from '../StellarSelectionAllocationsTable';
...
const winning: StellarSelectionAllocation = {
  EvtLogId: 1,
  TxHash: '0xABC123',
...
async function renderAndFlush(list: StellarSelectionAllocation[]) {
  const result = render(<StellarSelectionAllocationsTable list={list} />);
  await waitFor(() => {});
  return result;
}
