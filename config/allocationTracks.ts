 ...
 * (docs/design-system.md → Data series), fixed hues in every palette, so the palette's close
 * lilac primary and secondary never have to tell two tracks apart, and the neutral series for
 * the remainder that carries into the next cycle.
 */
