...
const networks: Record<NetworkName, NetworkConfig> = {
  local: {
    ...
    rpcUrl: process.env.NEXT_PUBLIC_RPC_URL || 'http://161.129.67.42:22945',
    explorerUrl: 'http://localhost',
    apiUrl: process.env.NEXT_PUBLIC_API_URL || 'http://161.129.67.42:7070/api/cosmicgame/',
  ...
  sepolia: {
    ...
    apiUrl:
      process.env.NEXT_PUBLIC_API_URL || 'http://161.129.67.42:8353/api/cosmicgame/',
    nftApiUrl: 'https://nfts.cosmicsignature.com/',
    infuraKey,
