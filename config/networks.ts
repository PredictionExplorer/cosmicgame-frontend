...
const networkDefaults: Record<NetworkName, Omit<NetworkConfig, 'apiUrl' | 'rpcUrl'>> = {
  local: {
    ...
    infuraKey,
    // Must match `statistics/dashboard` → `ContractAddrs` for your local chain (Hardhat default order).
    NFT_ADDRESS: '0xCf7Ed3AccA5a467e9e704C703E8D87F634fB0Fc9', // RandomWalkAddr
    ...
    COSMIC_SIGNATURE_ADDRESS: '0xDc64a140Aa3E981100a9becA4E685f962f0cF6C9', // CosmicSignature NFT
    COSMIC_SIGNATURE_DAO_ADDRESS: '0xB7f8BC63BbcaD18155201308C8f3540b07f84F5e',
    CHARITY_WALLET_ADDRESS: '0x8A791620dd6260079BF849Dc5567aDC3F2FdC318',
    STELLAR_SELECTION_WALLET_ADDRESS: '0x5FC8d32690cc91D4c39d9d3abcBD16989F875707', // PrizesWallet
    MARKETING_WALLET_ADDRESS: '0x2279B7A0a67DB372996a5FaB50D91eAA73d2eBe6',
    ANCHORING_WALLET_CST_ADDRESS: '0xa513E6E4b8f2a923D98304ec87F64353C4D5C853',
    ANCHORING_WALLET_RWLK_ADDRESS: '0x0165878A594ca255338adfa4d48449f69242Eb8F',
  ...
  mainnet: {
    ...
    STELLAR_SELECTION_WALLET_ADDRESS: '0x6300E1e97842d96bD84eEB8765867ee0e3F0f05E',
    MARKETING_WALLET_ADDRESS: '0xF6A795C64ad00F87470AbCe565F9546Ee2D27f3e',
    ANCHORING_WALLET_CST_ADDRESS: '0xee31260Bc475416eCAa6818EC8eFD7D432366a52',
    ANCHORING_WALLET_RWLK_ADDRESS: '0x82119eEdC25529b4193500555f15DE8794B9Dc56',
