...
export const aboutContentUk = {
  ...
  eyebrow: 'Офіційна сторінка проєкту',
  heading: 'Про Cosmic Signature',
  body: {
    paragraphs: [
      'Cosmic Signature — процедурний протокол ончейн-мистецтва на Arbitrum. Під час кожного перформанс-циклу учасники роблять жести в ETH або CST, і кожен жест допомагає сформувати фінальну Сигнатуру: детермінований NFT-твір, згенерований з ончейн-даних і відрендерений через фізичну симуляцію трьох тіл.',
      'Протокол побудовано на публічній механіці, яку кожен може перевірити. Смарт-контракти Arbitrum записують жести, цикли, напрями розподілу, CST, закріплення та закарбування NFT. Твори відтворювані з їхнього сіду, а проєкт наголошує на відкритому коді, мистецтві під CC0 та підтримці суспільних благ.',
  ...
  officialResources: {
    ...
    links: [
      ...
      { id: 'code', label: 'Ресурси вихідного коду', href: ABOUT_RESOURCE_HREFS.code },
