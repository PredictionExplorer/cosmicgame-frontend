...
export const aboutContentZhHk = {
  ...
  body: {
    paragraphs: [
      'Cosmic Signature 是 Arbitrum 上的程序化鏈上藝術協議。在每個演繹週期中，參與者以 ETH 或 CST 落筆；每一筆都在塑造最終的簽名——一件從鏈上數據生成、經三體物理模擬渲染而成的確定性 NFT 藝術作品。',
      '協議機制公開且可驗證。Arbitrum 智能合約記錄落筆、週期、分配軌道、CST、錨定和 NFT 銘刻。每件作品都能從種子復現。項目開放全部源代碼，以 CC0 發佈藝術作品，並將公共物品資助寫入協議機制。',
  ...
  officialResources: {
    ...
    links: [
      ...
      { id: 'privacy', label: '私隱政策', href: ABOUT_RESOURCE_HREFS.privacy },
      {
        id: 'support',
