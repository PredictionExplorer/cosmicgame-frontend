  ...
  'allocations-and-rewards': {
    ...
    items: {
      ...
      'what-rewards-per-bid': {
        question: '每次落筆會帶來什麼？',
        answer: `每筆落筆都會記錄 1 次週期末星選資格，更新堅守窗口對堅守冠軍和時之勇士軌道的貢獻，並可能銘刻參與 CST。參與 CST 按平方根公式計算：${protocolFacts.dynamicCstRewardFormula}。簡單來說，距上一筆落筆越久，數量越多，但增長速度會逐漸放緩。極短間隔可能得到 0 CST；較長的靜默期則可能產生更多 CST 銘刻。`,
      },
      'how-does-the-stellarSelection-work': {
        question: '星選如何運作？',
        answer: `每筆落筆都會記錄 1 次星選資格。每個週期結束時，智能合約會從資格池中進行程序化隨機選擇：${protocolFacts.ethStellarSelectionRecipients} 次選擇共同分得週期儲備中 ${protocolFacts.stellarSelectionEthPercentage}% 的 ETH；${protocolFacts.nftStellarSelectionRecipients} 次選擇各獲得 ${protocolFacts.specialAllocationCst.toLocaleString('zh-HK')} CST 與 1 枚 Cosmic Signature NFT；已錨定 Random Walk NFT 中另有 ${protocolFacts.anchoredRwlkNftSelectionRecipients} 次選擇，也各獲得 ${protocolFacts.specialAllocationCst.toLocaleString('zh-HK')} CST 與 1 枚 Cosmic Signature NFT。選擇採用放回方式，同一地址在同一週期內可能被選中多次。落筆次數越多，被選中的頻次也會增加。`,
      },
      ...
      'who-receives-10-percent': {
        ...
        answer:
          '週期收官時，週期儲備的 7% 會轉入公共物品金庫；此後任何人都可將金庫餘額轉給已配置的公共物品受益方。目前受益方為 Protocol Guild，這是支持 170 多位以太坊核心貢獻者的集體資助機制。目前，受益方地址由協議所有者設定；待協議所有權交由宇宙議會後，設計目標是由議會決定受益方。',
      },
    },
  },
  'game-mechanics': {
    ...
    items: {
      ...
      'what-is-chrono-warrior': {
        question: '什麼是時之勇士？',
        answer: `時之勇士是在堅守冠軍位置上連續保持最久的參與者。堅守冠軍對應保持「最近一筆落筆者」身份最久的人，時之勇士則對應保持堅守冠軍身份最久的人。週期收官時，時之勇士將獲得週期儲備中 ${protocolFacts.chronoWarriorEthPercentage}% 的 ETH、${protocolFacts.specialAllocationCst.toLocaleString('zh-HK')} CST 與 1 枚 Cosmic Signature NFT。`,
      },
  ...
  'tokens-and-nfts': {
    ...
    items: {
      'what-are-cst-and-dao': {
        ...
        answer:
          '每筆落筆都可能銘刻 CST 代幣；CST 用於表達宇宙議會中的協調權重。議會在鏈上協調協議：CST 持有者可以提交協調提案，並表達支持或反對。要啟用權重，需先把 CST 委託給自己或其他地址。待合約所有權交由議會後，議會按設計將管理協議參數，包括決定哪個公共物品受益方獲得 7% 的分配；目前這些設定仍由協議所有者管理。',
      },
