  ...
  'game-mechanics': {
    ...
    items: {
      ...
      'why-minimum-cst-reward-protection': {
        ...
        answer:
          '提交落筆前，應用程式會預覽預計獲得的參與 CST，並把你願意接受的最低 CST 數量傳送給合約。若另一筆落筆搶先成交，預計數量可能改變；如果最終銘刻量低於你設定的下限，最低 CST 銘刻保護可以阻止交易。你也可以選擇接受任意數量，包括 0 CST；此時只要價格檢查透過，落筆便可繼續。',
      },
  ...
  'tokens-and-nfts': {
    ...
    items: {
      ...
      'donate-nfts-to-game': {
        ...
        answer:
          '專案方可在落筆介面的「高階」面板中附加 ERC-721 或 ERC-20 代幣。填寫合約地址、代幣 ID 或數量後提交落筆。附加的代幣會由分配錢包託管，並在週期收官後流向簽名分配獲配者。',
      },
    },
  },
  'arbitrum-and-technical': {
    ...
    items: {
      'what-is-arbitrum': {
        ...
        answer:
          'Arbitrum 是以太坊 Layer 2 彙總網路，可加快交易並降低費用。Cosmic Signature 部署在 Arbitrum 上，既能把燃料費降至不足 1 美分並更快確認交易，又能保留以太坊的安全保障。',
      },
  ...
  'trust-and-governance': {
    ...
    items: {
      ...
      'get-help': {
        ...
        answer:
          '可透過 Discord、X / Twitter，以及「聯絡方式」頁面所列的支援信箱聯絡社群與支援團隊。',
      },
      'stay-updated': {
