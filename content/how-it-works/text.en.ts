  ...
  rewardBreakdown: {
    ...
    items: [
      ...
      },
      {
        ...
        description: `Each gesture records one entry. When the cycle finalizes, ${entriesAre(ethRecipients)} drawn at random to share ${protocolFacts.stellarSelectionEthPercentage}% of the Cycle Reserve in ETH.`,
      },
      {
        title: 'Cosmic Signature NFT selection',
        description: `Another ${entriesAre(nftRecipients)} drawn to receive ${cst} CST and a Cosmic Signature NFT each. The same address can be drawn more than once, and no number of entries guarantees a selection.`,
      },
      {
  ...
  gameCycle: {
    ...
    phases: [
      ...
      },
      {
        ...
        description: `The ETH Stellar Selection draws ${recipients(ethRecipients)}, who share ${protocolFacts.stellarSelectionEthPercentage}% of the Cycle Reserve. The NFT Stellar Selection draws ${numbers.count(nftRecipients)}, and the Anchored-NFT Stellar Selection draws ${numbers.count(anchoredRecipients)} from anchored Random Walk NFTs; each of them receives ${cst} CST and a Cosmic Signature NFT. Each gesture adds one entry, and the ETH and NFT selections draw from all of the cycle’s entries, with replacement.`,
      },
      {
