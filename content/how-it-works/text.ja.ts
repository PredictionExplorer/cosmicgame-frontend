...
export const howItWorksTextJa = {
  ...
  gameCycle: {
    ...
    phases: [
      ...
      {
        label: '星選',
        description: `3人のETH星選受領者がサイクル準備金の${protocolFacts.stellarSelectionEthPercentage}%を分け合います。10人のNFT星選受領者と、係留されたRandom Walk NFTから選ばれる10人の係留NFT星選受領者が、それぞれ${cst} CSTとCosmic Signature NFTを受け取ります。`,
      },
      {
        label: '次のサイクル',
