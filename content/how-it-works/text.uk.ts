...
export const howItWorksTextUk = {
  ...
  hero: {
    ...
    paragraph:
      'Жест за жестом учасники формують Сигнатуру протягом перформанс-циклу. Коли відлік дійде до нуля, цикл можна завершити. Тоді протокол виконає розподіли за фіксованим набором напрямів, серед яких розподіл Сигнатури, надходження за закріплення та підтримка Protocol Guild.',
