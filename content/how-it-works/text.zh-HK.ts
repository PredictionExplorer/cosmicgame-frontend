...
export const howItWorksTextZhHk = {
  ...
  overview: {
    ...
    cards: [
      ...
      {
        title: '獲配',
        description: '週期收官後，協議會按規則發放簽名分配、星選分配與錨定派發等。',
        tooltip: `寫下收官之筆的參與者會獲得週期儲備的 ${protocolFacts.mainEthPercentage}%、${protocolFacts.specialAllocationCst.toLocaleString('zh-HK')} CST 與 1 枚 Cosmic Signature NFT。星選獲配者、錨定者及其他參與者也會獲得相應分配。`,
      },
    ],
  },
  rewardBreakdown: {
    ...
    tips: [
      {
        ...
        tooltip:
          'ETH 落筆會略微縮短 CST 校準窗口，CST 落筆則會略微將其延長。目前價格走勢可在應用程式面板中即時查看。',
      },
      {
      ...
      {
        title: '使用專用錢包',
        description: '智能合約的源代碼已在鏈上公開驗證；使用專用錢包參與，還能再添一層保障。',
        tooltip: '專用錢包將協議操作與主要資產隔離，安全性更高。審計與驗證狀態可在審計頁面查看。',
      },
      {
        title: '留意收官倒數',
        description: '每一筆都會按目前時間增量延長鏈上記錄的週期收官時間。',
