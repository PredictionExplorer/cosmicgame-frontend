...
export const howItWorksTextZh = {
  ...
  gameCycle: {
    ...
    phases: [
      ...
      {
        label: '星选',
        description: `3 位 ETH 星选获配者均分周期储备的 ${protocolFacts.stellarSelectionEthPercentage}%。参与者 NFT 星选选出 10 位获配者，锚定 NFT 星选再从已锚定的 Random Walk NFT 中选出 10 位，每位获配 ${cst} CST 与 1 枚 Cosmic Signature NFT。`,
      },
      {
        label: '下一周期',
