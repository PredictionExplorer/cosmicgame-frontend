...
export const howItWorksContentZh = {
  ...
  overview: {
    ...
    cards: [
      ...
      },
      {
        ...
        tooltip: `写下收官之笔的参与者会获得周期储备的 ${protocolFacts.mainEthPercentage}%、${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。星选获配者、锚定者及其他参与者也会获得相应分配。`,
      },
    ],
  },
  rewardBreakdown: {
    ...
    items: [
      ...
      },
      {
        ...
        description: `每个周期，都有 10 位参与者经星选获配 ${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚独一无二的 Cosmic Signature NFT。`,
        tooltip: `每个周期，10 位星选获配者与 10 位 Random Walk NFT 锚定者，每位都会获配 ${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。`,
      },
      {
        title: '签名分配',
        description: `写下收官之笔的参与者，可取回周期储备中 ${protocolFacts.mainEthPercentage}% 的 ETH、${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。`,
  ...
  gameCycle: {
    ...
    phases: [
      ...
      {
        label: '周期收官',
        description: `写下收官之笔的参与者取回签名分配：周期储备的 ${protocolFacts.mainEthPercentage}%、${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。`,
        tooltip: '签名分配经由协议合约取回；CST 与 Cosmic Signature NFT 会自动完成铭刻。',
      },
      {
        label: '星选',
        description: `3 位 ETH 星选获配者均分周期储备的 ${protocolFacts.stellarSelectionEthPercentage}%；参与者 NFT 星选与锚定 NFT 星选各选出 10 位获配者，每位获配 ${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。`,
        tooltip:
  ...
  proTips: {
    ...
    tips: [
      ...
      },
      {
        ...
        tooltip: `3 位 ETH 星选获配者均分周期储备的 ${protocolFacts.stellarSelectionEthPercentage}%；10 位参与者 NFT 获配者与 10 位 Random Walk NFT 锚定者，每位获配 ${protocolFacts.specialAllocationCst.toLocaleString()} CST 与 1 枚 Cosmic Signature NFT。`,
      },
      {
        title: '使用专用钱包',
