...
export const landingTextKo = {
  meta: {
    ...
    description:
      'Cosmic Signature는 Arbitrum 위의 절차적 온체인 아트 프로토콜입니다. 모든 제스처가 사이클의 최종 시그니처를 빚어내고, 프로토콜은 그 결과를 함께 빚어낸 모든 참여자에게, 그리고 이더리움 자체가 의지하는 인프라에까지 준비금을 다시 배분합니다.',
    keywords: [
      'Cosmic Signature',
      '절차적 아트 프로토콜',
      '온체인 아트',
  ...
  hero: {
    ...
    subhead:
      '모든 제스처가 시그니처를 빚어냅니다. 퍼포먼스 사이클 동안 제스처를 남기면, 그 하나하나가 사이클의 최종 시그니처에 스며듭니다. 사이클이 마감되면 프로토콜은 준비금을 열 개가 넘는 배분 경로로 배분하며, 그 안에는 이더리움 자체가 의지하는 인프라도 있습니다.',
    biologyDisclaimer:
  ...
  art: {
    ...
    stages: {
      seed: {
        title: '시드',
        body: '블록 정보와 ArbSys 프리컴파일 같은 온체인 데이터에서 32바이트 해시를 얻은 뒤, SHA3-256 RNG에 넣습니다.',
      },
      simulation: {
        title: '시뮬레이션',
  ...
  tracks: {
    ...
    description:
      '사이클이 마감되면 프로토콜은 ETH와 CST 준비금을 끈기, 타이밍, 헌신, 참여를 인정하는 배분 경로로 배분합니다. ETH 준비금의 약 절반은 다음 사이클로 쌓여 넘어갑니다.',
    cardLabel: '배분',
    items: {
      ...
      'public-goods': {
        title: '공공재 배분',
        body: '170명이 넘는 이더리움 코어 기여자를 위한 자금 지원 메커니즘인 Protocol Guild로 전달됩니다.',
      },
      'anchor-distribution': {
        title: '앵커링 지급',
        body: '이 사이클 동안 프로토콜에 앵커링된 모든 Cosmic Signature NFT에 비례하여 지급됩니다.',
      },
  ...
  publicGoods: {
    eyebrow: '공공재',
    heading: '모든 사이클의 7%가 이더리움 코어 기여자에게 흘러갑니다.',
    body: '모든 퍼포먼스 사이클은 ETH 준비금의 7%를 Protocol Guild로 전달합니다. Protocol Guild는 170명이 넘는 이더리움 코어 기여자를 위한 공동 자금 지원 메커니즘입니다. 프로토콜이 많이 쓰일수록 이더리움 자체가 의지하는 인프라로 더 많이 흘러갑니다.',
  ...
  council: {
    ...
    columns: [
      ...
      {
        title: '조율 가중치',
        body: '위임된 CST는 하나마다 가중치 한 단위를 표현합니다. 의사 표현은 암호학적 서명이며, 주식이나 지분 증서가 아닙니다.',
      },
      {
        title: '조율 정족수',
        body: '찬성이 반대를 넘고, 찬성과 기권 가중치의 합이 CST 총공급량의 3%에 이르면 제안이 통과됩니다. 반대 가중치는 정족수에 포함되지 않습니다.',
      },
    ],
  },
  ...
  verifiability: {
    ...
    body: '누구나 시드로 시그니처를 다시 생성해 검증할 수 있습니다. 컨트랙트 검증, 정적 분석 노트, 보안 감사 현황은 보고서가 나오는 대로 앱을 통해 공개됩니다. 이 저장소의 프로젝트 소유 자료는 CC0 1.0으로 공개되며, 서드파티 의존성, 폰트, 에셋은 각자의 라이선스를 유지합니다.',
    pillars: [
      {
        title: 'CC0 1.0',
        body: '프로젝트 소유의 컨트랙트, 셰이더, 렌더링 파이프라인. 어떤 권리도 유보하지 않습니다. 서드파티 자료는 제외됩니다.',
      },
      {
        title: '검증 현황',
  ...
  faq: {
    ...
    items: [
      ...
      },
      {
        ...
        answer: `참여 CST 각인은 이전 제스처 이후 흐른 시간을 바탕으로 한 제곱근 공식을 사용합니다. 공백이 길수록 더 많은 CST가 각인되지만, 제곱근이라서 증가 폭은 선형보다 완만합니다. 매우 빠르게 이어지는 제스처는 0 CST를 각인할 수도 있습니다. 앱은 제출 전에 현재 수량을 미리 보여 줍니다.`,
      },
      {
      ...
      // lexicon-allow-start: explicit denial of charitable-tax-treatment framing.
      {
        ...
        answer:
          '각 사이클 ETH 준비금의 7%가 공공재 주소, 현재는 Protocol Guild로 전달됩니다. Protocol Guild는 170명이 넘는 이더리움 코어 기여자를 위한 공동 자금 지원 메커니즘입니다. 이는 공공재 주소로 ETH를 전달하는 것으로, 미국 세법상의 자선 기부가 아니며, Cosmic Signature는 그 세무상 취급에 관해 어떤 진술도 하지 않습니다.',
      },
      // lexicon-allow-end
      {
        question: '이 아트는 기술적으로 무엇인가요?',
        answer:
          '각 Cosmic Signature NFT는 뉴턴 중력 삼체 시뮬레이션의 결정론적 렌더입니다. 온체인 시드가 4차 요시다 심플렉틱 적분기로 시뮬레이션한 100,000개 가운데 후보 궤도 하나를 고르고, 그 궤도를 OKLab 색 혼합과 함께 64개의 파장 구간으로 스펙트럼 렌더링합니다. 파이프라인은 CC0로 완전히 오픈 소스이며, 누구나 시드로 시그니처를 재현할 수 있습니다.',
      },
      {
        question: '포크해도 되나요?',
        answer:
          '됩니다. 프로젝트 소유의 컨트랙트, 셰이더, 렌더러, 홍보 페이지, 문서는 CC0 1.0으로 공개되며 어떤 권리도 유보하지 않습니다. 서드파티 의존성, 폰트, 에셋은 각자의 라이선스를 유지합니다. THIRD_PARTY_NOTICES.md를 참고해 주세요.',
      },
    ],
  },
