...
const answerabilitySections: readonly LearnSection[] = [
  {
    ...
    body: [
      ...
      '會隨時間變化的資訊，請以應用程式中的即時數據為準；協議機制則以學習指南、常見問題、服務條款、安全、審計和風險披露頁面為準。',
    ],
  },
];
    ...
    'contracts-security-verification': {
      ...
      sections: [
        ...
        },
        {
          heading: '可供驗證的公開入口',
          body: [
            '驗證資訊分佈在多個公開入口。[合約頁面](contracts)列出部署地址與區塊瀏覽器連結，[源代碼頁面](code)介紹確定性渲染資源，[審計頁面](audits)說明審閱狀態，[安全頁面](security)則解釋如何查驗官方資源。',
