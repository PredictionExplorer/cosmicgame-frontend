      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '這種結構便於驗證。週期尚在推進時，讀者可檢視目前狀態；待其收官後，再回來比對分配紀錄、畫廊作品與統計。週期編號由此成為連線即時參與和歷史紀錄的橋梁。',
          ],
        },
        {
          heading: '週期中會發生哪些變化',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '合約與統計頁面把機制說明連線到鏈上紀錄：讀者可以先了解協議，再驗證實際資料。',
          ],
        },
        {
          heading: '應用程式頁面如何連線 Arbitrum 紀錄',
          body: [
