...
export const learnTextZhTw = {
  hub: {
    meta: {
      ...
      description:
        '了解 Cosmic Signature 的運作原理：演繹週期、落筆、CST、三體 NFT 藝術、Arbitrum 合約、錨定、公共財與風險釋疑。',
    },
    h1: '了解 Cosmic Signature',
    intro:
      '這裡彙集了一組簡明指南，帶你讀懂 Cosmic Signature。這套程序化鏈上藝術協議運作於 Arbitrum；參與者在演繹週期中落筆，共同塑造確定性的三體 NFT 藝術。',
    breadcrumbs: {
    ...
    groups: {
      ...
      context: {
        title: '背景',
        description: '公共財、收藏與交易作品的去處，以及協議不是什麼。',
      },
    },
    whitePaper: {
      eyebrow: '完整參考',
    ...
    quizCta: {
      heading: '自認已經讀懂協議了？',
      body: '一百道題，三個層級，全部出自白皮書。每道題都附有規則解說與原文章節，方便邊答邊學。',
      linkLabel: '開始知識測驗',
    },
  },
  articleUi: {
  ...
  articles: {
    'what-is-cosmic-signature': {
      cardTitle: '協議是什麼',
      cardDescription: '運作於 Arbitrum 的程序化藝術，由每個演繹週期的落筆共同塑造。',
      title: '什麼是 Cosmic Signature？ · Cosmic Signature',
      description:
        'Cosmic Signature 是運作於 Arbitrum 的程序化鏈上藝術協議；參與者在演繹週期中落筆，共同塑造確定性的三體 NFT 作品。',
      h1: '什麼是 Cosmic Signature？',
      summary:
        'Cosmic Signature 是運作於 Arbitrum 的程序化鏈上藝術協議。參與者在演繹週期中落筆，每一筆都會寫入鏈上紀錄，共同塑造由鏈上資料生成的確定性 Cosmic Signature NFT 作品。',
      sections: [
        {
          heading: '簡明定義',
          body: [
            'Cosmic Signature 將鏈上參與、確定性藝術生成與協議分配融為一體。協議運作於 Arbitrum——以太坊 Layer 2 網路，重要操作和紀錄都可在鏈上查驗。',
            '每個演繹週期都會彙集一系列落筆。週期收官後，最終簽名將銘刻為 NFT 作品，週期儲備則按協議規則發放至各條分配軌道，其中包括目前轉撥給 Protocol Guild 的公共財分配。',
          ],
        },
        {
          heading: '名稱為何重要',
          body: [
            ...
            'Cosmic Signature 與生物學中的 COSMIC 癌症突變資料庫或 COSMIC 突變特徵無關。它專注於確定性三體 NFT 藝術，是一套鏈上藝術協議。',
          ],
        },
        {
          heading: '協議有何獨特之處',
          body: [
            'Cosmic Signature 不只是畫廊或智慧合約介面。它以演繹週期串聯公開鏈上操作、確定性視覺輸出和分配機制。每個週期的最終簽名都來自公開的共同參與，而非一次孤立的銘刻操作。',
            '理解協議，可以從目前週期、最終簽名、CST、錨定、宇宙議會和公共財分配這些核心概念入手。所有紀錄都可回溯至 Arbitrum。',
          ],
        },
        {
          heading: '如何閱讀公開資料',
          body: [
            '無需連接錢包，也能在應用程式中檢視目前週期、統計、分配名錄、合約地址、畫廊和資助紀錄。',
            '品牌網站負責解釋機制與術語，應用程式網站提供即時狀態。兩者相互連結，方便讀者從概念說明前往鏈上紀錄。',
          ],
        },
      ],
    },
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '收官會銘刻週期結果、更新協議歷史，並將週期儲備發放至簽名分配、錨定配發、星選和公共財分配等軌道。',
          ],
        },
        {
          heading: '為何以週期為核心單位',
          body: [
            '演繹週期讓 Cosmic Signature 形成反覆展開的公共節奏。每一筆都歸入具體週期；每個週期都有開啟狀態、即時倒數、目前價格、參與紀錄、收官窗口和分配結果。',
            '這種結構便於驗證。週期尚在推進時，讀者可檢視目前狀態；待其收官後，再回來比對分配紀錄、畫廊作品與統計。週期編號由此成為串聯即時參與和歷史紀錄的橋梁。',
          ],
        },
        {
          heading: '週期中會發生哪些變化',
          body: [
            '隨著週期推進，落筆價格、收官倒數、參與 CST 的數量、公共財紀錄和領先狀態都可能變化。目前週期、統計、分配名錄和協調變更等頁面會同步呈現這些紀錄。',
            '週期收官後，相關狀態會歸入歷史。最終簽名、獲配紀錄、分配取回、已附加 NFT 和公共財資助也會進入公開檔案，供後續查閱。',
          ],
        },
      ],
    },
      ...
      sections: [
        {
          heading: '落筆會帶來什麼',
          body: [
            `每一筆都會寫入目前週期，可能銘刻參與 CST，延長收官倒數，併成為最終簽名歷史的一部分。參與 CST 的數量按平方根公式計算：${protocolFacts.participationCstNotation}，其中 ${protocolFacts.participationCstSymbols[0]} 為距上一筆的秒數，m 為參與 CST 乘數，i 為週期時間增量。`,
        ...
        },
        {
          ...
          body: [
            ...
            '即使不連接錢包，也能在公共頁面檢視這些機制和相關紀錄。',
          ],
        },
        {
          heading: '落筆是公開訊號',
          body: [
            '落筆是公開的鏈上操作，紀錄參與者與目前週期的互動，也會影響這一週期的最終簽名。無論使用 ETH 還是 CST，每一筆都會寫入週期紀錄。',
            '每筆紀錄都可追溯到參與者地址和發生時間，並顯示參與 CST、附加 NFT、週期延長及後續分配等資訊。',
          ],
        },
        {
          ...
          body: [
            ...
            '附加 Random Walk NFT 也會寫入公開紀錄。未使用的 Random Walk NFT 可在 ETH 落筆時附加，以獲得一次價格減免；已使用的 NFT 會單獨標記，方便事後核對。',
          ],
        },
      ],
    },
      ...
      sections: [
        {
          heading: '從鏈上種子到確定性渲染',
          body: [
            '每枚 Cosmic Signature NFT 都儲存著可復現作品的種子。渲染管線採用確定性輸入，因此同一種子始終生成相同的簽名作品。',
        ...
        },
        {
          heading: '開放且可復現',
          body: [
            '可復現性是這套協議的重要原則。藉助原始碼和渲染管線，任何人都能從種子出發，獨立驗證每件簽名作品。',
            '作品與相關技術均以 CC0 發布，任何人都可自由使用和改編。',
          ],
        },
        {
          heading: '確定性為何對藝術重要',
          body: [
            ...
            '確定性管線讓收藏者、開發者和研究者能夠驗證簽名影像是否與種子及渲染程式碼一致。原始碼、畫廊、代幣詳情和合約頁面也能相互印證。',
          ],
        },
        {
          heading: '從週期歷史到視覺身份',
          body: [
            '最終簽名不是隨意新增的裝飾。它是演繹週期的視覺終點，週期歷史則賦予影像文化與協議含義。作品由此成為一段公開過程完成後的可見印記。',
            '藝術作品是協議的一部分，不是脫離協議存在的媒體藏品。週期、代幣、畫廊、渲染管線和公開後設資料都指向同一 Cosmic Signature 協議。',
          ],
        },
      ],
    },
    'cosmic-signature-on-arbitrum': {
      ...
      cardDescription: '協議為何選擇以太坊 Layer 2 網路 Arbitrum。',
      title: '運作於 Arbitrum 的 Cosmic Signature · Cosmic Signature',
      description:
        '了解 Cosmic Signature 為何運作於 Arbitrum，以及協議如何藉助以太坊 Layer 2 基礎設施承載鏈上藝術。',
      h1: '運作於 Arbitrum 的 Cosmic Signature',
      summary:
        'Cosmic Signature 運作於 Arbitrum，讓落筆、週期、NFT 紀錄與分配都能在以太坊 Layer 2 網路上完成。',
      sections: [
        {
          heading: '為何選擇 Arbitrum',
          body: [
            'Arbitrum 在承接以太坊安全性的同時，提供成本更低的執行環境。參與者可能反覆落筆並查閱公開狀態，因此這一點對協議尤為重要。',
            '應用程式、合約、統計和畫廊都會明確標註 Arbitrum，方便核對協議所在的網路。',
          ],
        },
        {
          heading: '為何要明確標註網路',
          body: [
            'Cosmic Signature 在應用程式各處明確標註 Arbitrum，因為網路本就是協議身份的一部分。落筆、週期紀錄、合約地址、CST、NFT 所有權與分配取回，都需要指向具體網路，才能獨立查驗。',
            '[合約頁面](contracts)與[統計頁面](statistics)將機制說明連結至鏈上紀錄：讀者可以先了解協議，再驗證實際資料。',
          ],
        },
        {
          heading: '應用程式如何呈現 Arbitrum 紀錄',
          body: [
            '應用程式頁面會將原始鏈上紀錄和 API 資料整理成易讀資訊。分配頁面說明獲配者與週期結果，錨定頁面說明代幣狀態，公共財頁面說明資助與取回流向，畫廊則呈現代幣作品。',
    ...
    'contracts-security-verification': {
      cardTitle: '合約與驗證',
      cardDescription: '在哪裡查閱合約與原始碼，以及如何自行驗證。',
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '為避免相關措辭引發歧義，Cosmic Signature 將這套協調機制稱為「宇宙議會」，並將法律說明與風險揭露單獨呈現。',
          ],
        },
      ],
    },
    'anchoring-nfts': {
      cardTitle: '錨定 NFT',
      cardDescription: '已錨定的 NFT 如何分享每個週期的錨定配發，以及解錨的規則。',
      title: '錨定 Cosmic Signature NFT · Cosmic Signature',
      description:
        '了解 Cosmic Signature NFT 的錨定機制、ETH 錨定配發，以及 Random Walk NFT 的參與資格。',
      h1: '錨定 Cosmic Signature NFT',
      summary:
        '錨定後，Cosmic Signature NFT 可參與 ETH 錨定配發，Random Walk NFT 則可獲得錨定 NFT 星選資格。',
      sections: [
        {
          heading: '錨定配發',
          body: [
            'Cosmic Signature NFT 可錨定至協議。錨定後，它們會按協議規則參與該週期的 ETH 錨定配發；累積的 ETH 可在解錨時取回。',
            'Random Walk NFT 的錨定用途不同：錨定後可獲得錨定 NFT 星選資格，但不會參與 ETH 錨定配發。',
            '無論 Cosmic Signature 還是 Random Walk，每枚 NFT 都只能錨定一次。解錨時可取回 NFT 和累積的錨定配發，但此後無法再次錨定這枚 NFT。',
          ],
        },
        {
          heading: '錨定公開了什麼',
          body: [
            '無論是剛完成銘刻，還是從其他地址獲得，持有者都可將 NFT 錨定至協議。公開錨定頁面會展示錨定與解錨操作、已錨定代幣數量、配發紀錄，以及相關的 Random Walk NFT 活動。',
            '錨定是公開的協議機制。無需連接錢包，也能檢視已錨定代幣數量和配發紀錄。',
          ],
        },
        {
          heading: 'Cosmic Signature 與 Random Walk NFT 的不同作用',
          body: [
            'Cosmic Signature NFT 錨定後可參與 ETH 錨定配發；Random Walk NFT 錨定後則獲得錨定 NFT 星選資格。未使用的 Random Walk NFT 還可在 ETH 落筆時附加一次，以減免落筆價格。',
            '頁面會清楚標註代幣類型，並連結至統計、畫廊和目前週期頁面，方便核對相關紀錄。',
          ],
        },
      ],
    },
    'protocol-guild-public-goods': {
      ...
      title: 'Cosmic Signature 與以太坊公共財 · Cosmic Signature',
      description:
        '了解 Cosmic Signature 如何將公共財分配轉撥至 Protocol Guild，為以太坊核心貢獻者提供資助。',
      h1: 'Cosmic Signature 與以太坊公共財',
      summary:
        'Cosmic Signature 設有公共財分配軌道，目前會將每個週期的一部分儲備轉撥給 Protocol Guild。',
      sections: [
        {
          heading: 'Protocol Guild 分配',
          body: [
            'Protocol Guild 為 170 多位以太坊核心貢獻者提供資助。Cosmic Signature 目前將公共財分配轉撥至 Protocol Guild。',
            '這說明公共財分配是協議設計的一部分，而不是應用程式介面中的附帶說明。',
          ],
        },
        {
          heading: '公共財為何屬於協議本身',
          body: [
            '公共財轉撥是協議內的一條固定分配軌道。按現行規則，週期儲備的一部分會轉至公共財受益方，目前為 Protocol Guild。',
            '公共財頁面會列出資助、取回和受益方紀錄，方便驗證資金流向及其與週期參與的關係。',
          ],
        },
        {
          heading: '如何驗證公共財流向',
          body: [
            '公共財資助頁面紀錄存入金額，取回頁面紀錄從金庫轉撥的資金；合約頁面提供地址，統計頁面則給出彙總背景。',
            'Cosmic Signature 僅說明公開紀錄中的資金流向，不對稅務處理或法律地位作任何暗示。',
          ],
        },
      ],
    },
    'collecting-and-trading-cosmic-signature': {
      cardTitle: '收藏與交易',
      cardDescription: 'NFT 與 CST 在哪裡交易，以及交易前需要核對什麼。',
      title: '收藏與交易 Cosmic Signature NFT 和 CST · Cosmic Signature',
      description:
        '了解 Cosmic Signature 資產可在哪裡交易：Axiom Zero NFT 市場不收平台費，可在 Arbitrum 上透過 Uniswap 兌換 CST，Chaos Zero 則提供週期預測市場。',
      h1: '收藏與交易 Cosmic Signature',
      summary:
        'Cosmic Signature NFT 可在 Axiom Zero 交易。該市場專注於 Arbitrum 上公平發布的生成藝術，不收平台費。CST 可在 Uniswap 交易；Chaos Zero 則為每個演繹週期開設預測市場。',
      sections: [
        {
          heading: '資產在哪裡交易',
          body: [
            'Cosmic Signature NFT 是 Arbitrum 上的標準 ERC-721 代幣，主要在 Axiom Zero 交易。Axiom Zero 專注於採用公平發布機制的生成藝術，不收平台費；每次掛單或成交都透過單筆鏈上交易完成，賣方收到全部成交金額。市場收錄 Cosmic Signature 和 Random Walk 兩個 Axiom Zero 系列，頁面價格均直接來自已驗證的市場合約。',
        ...
        },
        {
          ...
          body: [
            ...
            '市場根據公開的鏈上落筆次數判定結果。一旦次數超過上一週期總數，結果便已確定；交易會在同一區塊停止，此後只能取回相應資產。Chaos Zero 沒有所有者、管理金鑰或升級路徑。',
          ],
        },
        {
          heading: '錨定狀態如何影響收藏',
          body: [
            ...
            'Axiom Zero 會從錨定合約即時讀取狀態，將每枚代幣標為從未錨定或已錨定；每個系列內也可按該狀態篩選代幣。這樣一來，市場中的代幣說明便與應用程式展示的鏈上錨定紀錄保持一致。',
          ],
        },
        {
          heading: '如何驗證交易場所與地址',
      ...
      sections: [
        {
          heading: '直接說明',
          body: [
            '參與者在演繹週期中落筆。週期收官後，協議會按既定軌道發放分配。這裡沒有莊家，沒有荷官，也沒有賭注。',
        ...
        },
        {
          heading: '如何理解分配措辭',
          body: [
            '這裡所說的分配，是指週期收官後由協議按規則發放的資產，不代表利潤分成、股息權、股權或任何承諾的財務回報。參與前，請閱讀風險揭露和服務條款。',
            '無需連接錢包，也能閱讀協議說明、服務條款和風險揭露。',
          ],
        },
      ],
    },
