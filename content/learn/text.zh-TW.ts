...
const answerabilitySections: readonly LearnSection[] = [
  {
    ...
    body: [
      ...
      '會隨時間變化的資訊，請以應用程式中的即時資料為準；協議機制則以學習中心、常見問題、服務條款、安全、審計和風險揭露頁面為準。',
    ],
  },
];
      ...
      sections: [
        ...
        },
        {
          ...
          body: [
            ...
            '合約與統計頁面將機制說明連結至鏈上紀錄：讀者可以先了解協議，再驗證實際資料。',
          ],
        },
        {
    ...
    'contracts-security-verification': {
      ...
      sections: [
        ...
        },
        {
          heading: '可供驗證的公開入口',
          body: [
            '驗證資訊分佈在多個公開入口。合約頁面列出部署地址與區塊瀏覽器連結，原始碼頁面介紹確定性渲染資源，審計頁面說明審閱狀態，安全頁面則解釋如何查驗官方資源。',
