...
export const auditsCopyZhTw: TrustPageCopy = {
  eyebrow: '審計與驗證',
  title: 'Cosmic Signature 審計',
  intro:
    '查閱 Cosmic Signature 的合約審計與驗證資料，了解審查範圍、發現及處理狀態，並核對公開的合約實作。',
  sections: [
    {
      heading: 'Hacken 獨立審計',
      paragraphs: [
        ...
        '除人工審查外，Hacken 還對 14 項系統不變量進行了模糊測試，例如協議持有的 ETH 總額必須等於存入減去取回。全部 14 項不變量在 10,000 次執行中均保持成立。',
      ],
      linkParagraph: {
        kind: 'external',
    ...
    },
    {
      ...
      bullets: [
        '在官方合約頁面確認合約地址。',
        '在 Arbitrum 區塊瀏覽器中比對已驗證原始碼與 ABI 資料。',
    ...
    },
    {
      ...
      links: [
        ...
        { kind: 'app', href: '/code', label: '原始碼與確定性渲染資源' },
