...
/** Traditional Chinese (Hong Kong) copy for /risk-disclosures, rendered by RiskContent. */
export const riskCopyZhHk: RiskCopy = {
  title: '風險披露',
  ...
  groups: [
    {
      ...
      risks: [
        ...
        '校準窗口會改變 CST 落筆價格：無人進行 CST 落筆時價格持續下降，每次 CST 落筆後又會以更高的價格重新開始，因此你看到的價格可能在交易上鏈前出現變化。',
      ],
      source: '規則見服務條款中的<termsMechanics>協議機制與智能合約</termsMechanics>。',
    },
    {
      id: 'timing',
      heading: '時間與取回',
      risks: [
        `完成收官之筆的參與者可在週期收官時間之後的 ${facts.finalGestureExclusivityHours} 小時內獨自完成收官。此後任何人都可以完成收官，並按照合約規則成為簽名分配的獲配者。`,
    ...
    },
    {
      ...
      heading: '錢包與密鑰',
      risks: [
        '密鑰只由你自己掌握。任何取得你助記詞的人都能控制你的錢包，而遺失的助記詞無法找回。',
        '錢包提示授予的權限可能比看起來更多。請閱讀每一項批准，並只使用<securityOfficial>官方地址</securityOfficial>。',
      ],
    ...
    },
    {
      ...
      heading: '網絡與應用程式',
      risks: [
        '網絡擠塞、RPC 中斷、索引延遲或應用程式問題，都可能延遲或阻斷交易以及本網站顯示的資料。',
        '本網站顯示的資料可能比鏈上狀態落後幾秒或更久。兩者不一致時，以 Arbitrum 上的合約為準。',
        '智能合約可能存在審計未能發現的缺陷。審計檢查了哪些內容，請見<audits>審計</audits>。',
      ],
  ...
  participation: {
    ...
    paragraphs: [
      ...
      '了解為何 Cosmic Signature <notALottery>不是彩票、賭場或投資</notALottery>。',
      // lexicon-allow-end
    ],
  },
};
