...
export const securityCopyZhHk: TrustPageCopy = {
  eyebrow: '信任與安全',
  ...
  sections: [
    {
      heading: '安全模型',
      paragraphs: [
        '協議操作由 Arbitrum 智能合約記錄。連接錢包或落筆前，公開頁面應便於用戶與抓取工具檢查合約地址、源代碼資源、驗證背景及運行假設。',
      ],
      bullets: [
    ...
    },
    {
      heading: '驗證資源',
      paragraphs: [
        '可見的應用程式內容、已驗證合約、源代碼與 Arbitrum 即時數據彼此一致，是最有力的安全信號。',
      ],
      links: [
        { kind: 'app', href: '/contracts', label: 'Cosmic Signature 合約與 Arbitrum 地址' },
        { kind: 'app', href: '/code', label: 'Cosmic Signature 源代碼與渲染流水線' },
        { kind: 'app', href: '/audits', label: '審計與形式化驗證說明' },
        { kind: 'app', href: '/risk-disclosures', label: '風險披露與參與說明' },
      ],
    },
  ],
};
