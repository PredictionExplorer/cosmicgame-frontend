    ...
    },
    {
      ...
      content: [
        ...
        },
        {
          id: 'signature',
          subtitle: '签名分配',
          text: `完成收官之笔的参与者可以取回 ${ethDistributionFacts.mainEthPercentage}% 的 ETH、${protocolFacts.specialAllocationCst.toLocaleString('zh-CN')} CST 表彰铭刻、1 枚 Cosmic Signature NFT，以及该周期中可能存在的已附加代币。`,
        },
        {
          id: 'chrono',
          subtitle: '时之勇士',
