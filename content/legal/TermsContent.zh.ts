      ...
      content: [
        {
          id: 'distribution',
          subtitle: '分配发放',
          text: `分配按照智能合约规则自动发放。通常，每个周期会沿下列分配轨道铭刻 ${nftAllocationFacts.typicalNftsPerCycle} 枚 Cosmic Signature NFT 与 ${protocolFacts.typicalCstImprintsPerCycle.toLocaleString('zh-CN')} CST。`,
        },
        {
          id: 'signature',
          subtitle: '签名分配',
          text: `完成收官之笔的参与者可以取回 ${ethDistributionFacts.mainEthPercentage}% 的 ETH、${protocolFacts.specialAllocationCst.toLocaleString('zh-CN')} CST 表彰铭刻、${nftAllocationFacts.mainPrizeNftPhrase.zh}，以及该周期中可能存在的已附加代币。`,
        },
        {
          id: 'chrono',
          subtitle: '时之勇士',
          text: `连续保持坚守冠军身份时间最长的参与者将获得 ${ethDistributionFacts.chronoWarriorEthPercentage}% 的 ETH、${protocolFacts.specialAllocationCst.toLocaleString('zh-CN')} CST 表彰铭刻与 1 枚 Cosmic Signature NFT。`,
        },
        {
          id: 'endurance',
          subtitle: '坚守冠军',
