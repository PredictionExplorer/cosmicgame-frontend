...
export const quizTextKo = {
  hub: {
    ...
    intro:
      '백서를 바탕으로 엮은 세 단계 100문항: 사이클, 제스처, 배분, 아트 파이프라인, 그리고 꼼꼼한 독자만 알아채는 경계 사례까지 다룹니다. 모든 답에는 해설과 함께 그 규칙을 정해 두는 백서 섹션으로 가는 안내가 붙습니다. 답하는 일이 곧 읽는 일입니다.',
    breadcrumbs: {
      ariaLabel: '탐색 경로',
      homeLabel: '홈',
      quizLabel: '퀴즈',
  ...
  ui: {
    ...
    correctFeedback: [
      '정답입니다. 궤도가 유지됩니다.',
      '정확합니다.',
      '정답입니다. 시드가 물리 법칙을 읽어 내듯 프로토콜을 읽어 냈습니다.',
      '맞습니다. 깔끔한 궤적입니다.',
    ],
    incorrectFeedback: [
      '조금 다릅니다. 프로토콜이 실제로 하는 일은 이렇습니다.',
      '흔한 오해입니다. 메커니즘은 다르게 말합니다.',
      '궤도는 가까웠지만 천체가 다릅니다. 규칙은 이렇습니다.',
      '이번에는 아닙니다. 백서가 결론을 내립니다.',
    ],
    ...
    summary: {
      ...
      ranks: {
        observer: {
          name: '관측자',
          line: '표면까지는 보았습니다. 더 가까운 궤도로 다가갈수록 백서는 더 많은 것을 보여 줍니다.',
        },
        participant: {
          name: '참여자',
          line: '움직이는 부품은 파악했습니다. 이 설계가 정말 흥미로워지는 곳은 경계 사례입니다.',
        },
        enduranceChampion: {
          name: '수호 챔피언',
          line: '메커니즘을 길고 흔들림 없이 붙들었습니다. 빈틈이 거의 남지 않았습니다.',
        },
        chronoWarrior: {
          name: '시간의 전사',
      ...
      studyIntro: '틀린 문항과, 그 답을 정해 두는 백서 섹션입니다:',
  ...
  tiers: {
    basic: {
      ...
      description:
        '기본 개념 25문항: 제스처란 무엇인지, 사이클이 어떻게 마감되는지, ETH가 어디로 가는지, 작품이 왜 결정론적인지. 처음이라면 여기에서 시작하세요.',
    ...
    medium: {
      ...
      description:
        '작동 중인 메커니즘 25문항: 비용 곡선, CST 피드백 루프, 수호 챔피언과 시간의 전사의 차이, 별빛 선정의 셈법, 평의회 매개변수. 사이클을 한두 번 지켜본 독자를 위한 단계입니다.',
    ...
    hard: {
      ...
      description:
        '꼼꼼한 독자를 위한 50문항: 카운트다운 만료 이후의 규칙, ETH를 거부하는 컨트랙트, V2가 다섯 가지를 바꾼 이유, V3가 다시 매기는 가격, 무작위성이 만들어지는 방식, 그리고 요시다 적분기가 아트 프로젝트에서 하는 일.',
