...
export const mediumQuestionsTextZhHk = {
  ...
  'cst-free-quiet': {
    ...
    options: {
      a: 'CST 落筆價格已降至零，無需支付 CST，但仍需支付網絡燃料費。',
      b: '週期自動完成收官。',
      c: '在 ETH 落筆到來之前，CST 落筆被禁用。',
      d: 'CST 價格已升至上限。',
    },
    explanation:
      '校準窗口完整走完後，CST 落筆價格可降至零。落筆仍需支付網絡燃料費，並滿足目前週期規則。收官也需要有人提交交易，週期不會自動收官。',
    referenceLabel: '白皮書 §4.3 · CST 落筆',
  },
  ...
  'chrono-definition': {
    prompt:
      'Ari 創下十小時的堅守紀錄，連續保持堅守冠軍身份兩天後，紀錄才被 Bea 刷新。時之勇士衡量的是什麼？',
    options: {
