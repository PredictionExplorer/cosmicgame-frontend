...
export const quizTextVi = {
  hub: {
    ...
    durationTemplate: 'Khoảng {minutes} phút',
    difficultyTemplate: 'Độ khó {level}/{max}',
    bestTemplate: 'Tốt nhất: {correct}/{total}',
    inProgressTemplate: 'Đang làm: câu {current} trên {total}',
  ...
  ui: {
    ...
    correctAnswerTemplate: 'Đáp án đúng là {letter}.',
    ...
    summary: {
      ...
      studyHeading: 'Câu hỏi cần xem lại',
      studyIntro: 'Câu trả lời của bạn, đáp án đúng và quy tắc giải thích đáp án đó.',
      noMissesNote: 'Không có gì để xem lại \u2014 mọi câu trả lời đều đúng.',
      restartLabel: 'Bắt đầu lại với thứ tự mới',
      nextTierTemplate: 'Chuyển sang {tier}',
