import { basicQuestionsZh } from './basic.zh';
import { hardQuestionsZh } from './hard.zh';
import { mediumQuestionsZh } from './medium.zh';
import type { QuizContent } from './types';

export const quizContentZh = {
  hub: {
    eyebrow: '知识测验',
