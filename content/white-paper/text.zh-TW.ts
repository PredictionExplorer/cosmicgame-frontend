...
export const whitePaperTextZhTw = {
  metadata: {
  ...
  sections: {
    introduction: {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'Cosmic Signature 源於兩個信念。其一，生成藝術最動人的時刻，是它沒有任何隨意性：每幅影像都是物理過程的輸出，由種子唯一確定，任何人重跑一遍流程即可驗證結果。其二，一個替參與者保管 ETH 的協議，應當對「每一個 wei 去了哪裡」給出機械的、可讀的答案。',
        },
        {
          kind: 'paragraph',
        ...
        {
          kind: 'paragraph',
          text: '本文是協議的權威說明。第 2 節勾勒系統全貌；第 3 至 5 節定義週期、落筆與分配；第 6 節介紹藝術；第 7 至 10 節涵蓋 CST、錨定、宇宙議會與公共財；第 11 節討論安全與可驗證性；第 12、13 節紀錄升級歷史與全面去中心化路線；第 14 節直言協議不是什麼。文中引用的數字要麼是合約常量，要麼是鏈上參數的上線初始值；附錄 A 所列的已部署合約始終是最終依據。',
        },
      ],
    },
    'protocol-overview': {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: '系統由一份核心合約和環繞它的一組單一職責合約構成。核心合約部署在可升級代理之後，負責運轉週期：為落筆定價、維護倒數、持有週期儲備、執行收官。環繞它的是 CST 代幣、Cosmic Signature NFT 系列、分配託管錢包、兩個錨定錢包、公共財金庫、推廣儲備與宇宙議會。',
        },
        {
          kind: 'table',
          table: {
            ...
            rows: [
              ...
              [
                '錨定錢包',
                '一個面向 Cosmic Signature NFT（ETH 錨定配發），一個面向 Random Walk NFT（星選資格）。',
              ],
              ['公共財金庫', '接收並轉撥每週期的公共財分配，受益方目前為 Protocol Guild。'],
              [
                '推廣儲備',
                `每週期接收 ${cst(protocolFacts.outreachReserveCst)} CST，用於社群推廣。`,
              ],
        ...
        {
          kind: 'paragraph',
          text: '合約之外，一個生態正在生長：應用程式位於 app.cosmicsignature.com，NFT 在 Axiom Zero 市場流通，CST 在 Arbitrum 上有 Uniswap 流動性，Chaos Zero 則為每個週期提供預測場所。它們都不是必需的：本文所述的每項機制，都可以直接呼叫合約完成。',
        },
      ],
    },
    'performance-cycle': {
      ...
      subsections: {
        'eth-calibration-window': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: `每個週期的首筆落筆必須使用 ETH，其價格由 ETH 校準窗口決定。窗口起始價為上一週期開場實付價格的 ${protocolFacts.ethCalibrationCeilingMultiplier} 倍，隨後線性下行，直至起始價的兩百分之一加 1 wei。按上線參數，整段下行約需兩天；時長與週期時間增量掛鉤，會隨協議年歲緩慢拉長。若窗口走完仍無人落筆，價格便停在底價等待。第一個週期以固定的 ${protocolFacts.initialGestureCostEth} ETH 開場。`,
            },
            {
              kind: 'paragraph',
        ...
        finalization: {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: '週期收官時間一到，收官之筆參與者即可收官。收官是一筆交易：讀取協議的 ETH 餘額，按第 5 節的軌道發放，銘刻本週期的 NFT 與 CST，為每件新作品紀錄種子，並排定下一週期。',
            },
            {
              kind: 'paragraph',
      ...
      subsections: {
        ...
        'cst-gestures': {
          ...
          blocks: [
            ...
            {
              kind: 'paragraph',
              text: `窗口時長本身也是鏈上的活參數，是協議裡一條安靜的回饋迴路。它從 ${protocolFacts.initialCstCalibrationWindowHours} 小時的基準出發：每筆 ETH 落筆使其縮短約 ${protocolFacts.cstCalibrationWindowDecreasePercentPerEthGesture}%，每筆 CST 落筆使其延長約 ${protocolFacts.cstCalibrationWindowIncreasePercentPerCstGesture}%。ETH 落筆越密集，CST 價格降得越快，CST 落筆越早變得划算；CST 落筆多了，下行又會放慢。這條迴路把每個週期推向兩種貨幣的均衡組合。`,
            },
            {
              kind: 'paragraph',
        ...
        'messages-and-attachments': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: `落筆可攜帶最長 ${protocolFacts.gestureMessageMaxLength} 位元組的訊息，與落筆一同記錄在鏈上；也可附加 ERC-20 代幣或一枚 ERC-721 NFT。附加資產不進入 ETH 儲備，而由分配錢包託管；週期收官後，受益方享有優先取回權，並受第 5.4 節的公開取回期限約束。`,
            },
          ],
        },
      },
      ...
      subsections: {
        ...
        'delivery-and-timeouts': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: '發放刻意分成兩類：主動送達與自行取回。簽名分配的 ETH 在收官時直接送達受益方，公共財轉撥亦然；時之勇士的 ETH 與三份 ETH 星選份額則存入分配錢包託管，獲配者隨時取回。CST 與 NFT 在收官時直接銘刻到各自獲配者名下。',
            },
            {
              kind: 'paragraph',
    ...
    'the-art': {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          text: '任何階段都沒有生成式模型參與。沒有訓練資料，沒有采樣，也沒有提示詞。管線就是一段物理模擬加一個渲染器，以 Rust 寫成，完全開源，徹底確定。',
        },
      ],
      subsections: {
        'art-pipeline': {
          ...
          blocks: [
            ...
            {
              kind: 'paragraph',
              text: '每枚 NFT 的最終輸出，是一張 16 位元 PNG 與一段 30 秒 H.265 影片。',
            },
          ],
        },
        'reproducibility-and-license': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: '確定性靠機制保證，而非口頭承諾。同一種子在任何機器上都產出逐畫素一致的影像，生成幀的 SHA-256 雜湊在持續整合中逐一斷言。種子全部在鏈上，管線完全公開，這個系列因此不依賴任何伺服器：哪怕明天所有伺服器都消失，每幅簽名都能從鏈上重生。',
            },
            {
              kind: 'paragraph',
              text: '所有者可在鏈上為 NFT 命名，最長 32 位元組。專案自有的合約、著色器與渲染管線均以 CC0 1.0 獻入公有領域，不保留任何權利；第三方依賴保留各自的授權。',
            },
          ],
        },
      },
    ...
    cst: {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'CST 是協議的 ERC-20 代幣。供應量從零起步，代幣合約只接受協議合約的銘刻與銷燬指令。流通中的每一枚 CST，都能追溯到某個週期裡的一次參與。',
        },
      ],
      subsections: {
        'imprint-rules': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: `CST 經三條途徑進入流通。參與 CST 在落筆時按下方公式銘刻。表彰 CST 在收官時銘刻：本週期每份 NFT 發放都伴隨 ${cst(protocolFacts.specialAllocationCst)} CST，典型週期共 ${protocolFacts.typicalNftsPerCycle} 份。此外，每週期還有 ${cst(protocolFacts.outreachReserveCst)} CST 進入推廣儲備，由團隊用於社群推廣；這是團隊經手的唯一一條固定 CST 流，且不附帶任何特殊權限。`,
            },
            {
              kind: 'formula',
    ...
    anchoring: {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: `錨定是協議的長期對齊方式。所有者可將 Cosmic Signature NFT 錨定至協議；錨定期間，它按比例累積每週期 ${protocolFacts.anchorDistributionPercentage}% 的錨定配發，累積的 ETH 在解錨時取回。錨定沒有固定期限，也沒有任何罰則，但它是每枚 NFT 一次性的決定：每枚 NFT 一生僅可錨定一次，解錨即永久失去錨定資格。`,
        },
        {
          kind: 'paragraph',
        ...
        {
          kind: 'paragraph',
          text: `Random Walk NFT 的錨定自成一線，目的也不同：已錨定的 Random Walk NFT 參與錨定 NFT 星選（見第 5.3 節），每週期 ${protocolFacts.anchoredRwlkNftSelectionRecipients} 次，每次攜帶 ${cst(protocolFacts.specialAllocationCst)} CST 與一枚 Cosmic Signature NFT。Random Walk 錨定不含 ETH 配發。一生一次的規則同樣適用。`,
        },
      ],
    },
    'cosmic-council': {
    ...
    'public-goods': {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: `每個週期都將週期儲備的 ${protocolFacts.publicGoodsPercentage}% 轉撥給公共財金庫，其受益方目前是 Protocol Guild，即 170 餘位以太坊核心協議貢獻者的集體資助機制。轉撥作為收官的一部分在鏈上強制執行，沒有人逐週期決定是否兌現。協議使用得越多，流向以太坊賴以運轉的基礎設施的也就越多。`,
        },
        {
          kind: 'paragraph',
        ...
        },
        {
          ...
          kind: 'note',
          text: '此處是將 ETH 轉撥至公共財地址（目前為 Protocol Guild）的行為，不構成美國稅法意義上的慈善捐贈，Cosmic Signature 亦不對其在任何司法轄區的稅務處理作出任何陳述。',
          // lexicon-allow-end
        },
      ],
    },
      ...
      subsections: {
        'independent-review': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: '2025年末，Hacken 對 Cosmic Signature 合約完成了獨立安全審查，範圍覆蓋核心協議、CST 代幣、兩個 NFT 整合、錨定錢包，以及配套的錢包與系統管理合約。最終報告於2026年1月發布，共列出 23 項發現：無嚴重級，無高危級，中危 3 項、低危 8 項、資訊級 12 項，其中多數是團隊已審閱並附書面理由接受的設計取捨。',
            },
            {
              kind: 'paragraph',
            ...
            {
              kind: 'paragraph',
              text: '外部審查之外，程式碼儲存庫還帶有 Certora 形式化驗證規範、Solidity SMTChecker 配置、Slither 靜態分析，以及一套以 Solidity 原始碼全覆蓋為目標的測試。',
            },
          ],
        },
        'defensive-design': {
          ...
          blocks: [
            {
              ...
              items: [
                '重入防護覆蓋核心合約的每個外部入口。',
                '取回優先於送達：次級 ETH 分配與附加資產存入托管，而非在收官時直接傳送，任何獲配方合約都無法藉此阻塞週期落幕。',
                '容錯轉撥：公共財轉帳若無法完成，收官照常進行，事件記錄在案，留待後續處理。',
                '週期間鎖定：週期執行期間，核心參數不可更改，合約不可升級（見第 13 節）。',
              ],
            },
          ],
        },
        ...
        'open-verification': {
          ...
          blocks: [
            {
              kind: 'paragraph',
              text: '全部合約都已在 Sourcify 上以精確匹配狀態完成原始碼驗證（鏈 ID 42161），地址固定於附錄 A。藝術管線的確定性由持續整合斷言：生成幀的 SHA-256 雜湊逐一核對。專案自有程式碼均為 CC0：任何人都可以復刻合約、渲染器或網站，也可以用種子重新生成任何一幅簽名來驗證。',
            },
          ],
        },
      },
    ...
    'upgrade-history': {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'Cosmic Signature 的設計目標是「完工」。可升級性之所以存在，是為了在協議早期能對照真實行為修正機制；設計定稿之日，就是它謝幕之時。本節紀錄已經發生的與尚待發生的。',
        },
      ],
      subsections: {
        v1: {
        ...
        v3: {
          ...
          blocks: [
            ...
            {
              kind: 'paragraph',
              text: '指數是關鍵。八次方的曲線讓溢價在窗口的大部分時間裡幾乎無感，只在最後陡然直立：距收官 10 分鐘約 1.04 倍，5 分鐘約 1.9 倍，1 分鐘約 7 倍，到點 10 倍。',
            },
            {
              kind: 'paragraph',
              text: '意圖是改寫終局。V2 之下，拖到最後幾秒落筆近乎零成本，週期可能在一陣低訊號的卡點操作中收場。V3 之下，壓哨一筆成了昂貴的表態，貫穿週期的持續參與相對便宜，想在第 5.2 節的堅守軌道上偷襲得手，也難得多。參數在部署前仍可能微調，機制則如上所述。',
            },
          ],
        },
      },
    ...
    decentralization: {
      ...
      blocks: [
        ...
        {
          kind: 'paragraph',
          text: '週期執行期間，核心參數全部鎖定：所有者不能在週期中途更改比例、增量或價格，也不能升級合約；所有者的操作只存在於週期與週期之間的縫隙裡。另有三項範圍更窄的權限隨時可用：把下一週期的啟用時間向後推（僅限其首筆落筆到來之前）、調整下一週期前的延遲，以及管理外圍合約，即公共財金庫受益方、NFT 後設資料 URI 與託管取回期限。任何所有者權限都觸不到託管中的分配、已銘刻的 NFT、已紀錄的種子或任何人的 CST 餘額；也沒有任何團隊錢包從落筆中收取 ETH。',
        },
        {
          kind: 'paragraph',
          text: '這些權限之所以存在，是因為機制是全新的。V2 的每一項改動都來自線上真實行為的教訓，V3 亦然；一段有邊界、全公開的調整期，是設計走向完工的方式。清單裡最強的權限是升級本身，而它同樣公開：新實現上鏈即可見、可驗證，且必須趕在下一週期開始之前完成。',
        },
        {
          kind: 'paragraph',
          text: '終點是這樣約定的：待以 V3 為首的剩餘升級完成、機制與代幣設計定稿，部署者地址將交出全部特權控制。所有者角色將永久離開部署者，或轉交宇宙議會，或直接放棄所有權，具體方式會提前公佈。自那時起，任何私人主體都無法再升級協議或更改參數，部署者地址所擁有的，與其他任何地址再無不同。留下來的，是按部署形態執行的協議、作為協調層的議會，以及藝術本身。',
        },
        {
          kind: 'paragraph',
          text: '這一程序的每一步都在鏈上公開可見，包括最後一步。',
        },
      ],
    },
    clarifications: {
      ...
      subsections: {
        'what-it-is-not': {
          ...
          blocks: [
            ...
            {
              kind: 'paragraph',
              text: 'Cosmic Signature 不是彩票，不是賭場，也不是賭博產品。這裡沒有莊家，沒有荷官，也沒有賭注。參與者以價值換取參與本身：每一筆都是塑造作品、延長週期並永久記錄在鏈上的表達行為。協議不留任何運營方抽成；第 5 節的每條分配軌道，流向的都是參與者、已錨定的 NFT、滾動儲備或公共財。',
            },
            {
              kind: 'paragraph',
              text: 'Cosmic Signature 也不是投資產品，本文的任何內容都不構成投資建議或證券要約。CST 與 Cosmic Signature NFT 是參與憑據與藝術物件，協議不對其價格、流動性或未來價值作任何承諾；任何人都不應帶著「憑他人努力獲利」的預期取得它們。',
            },
            // lexicon-allow-end
          ],
        },
          ...
          blocks: [
            {
              kind: 'list',
              items: [
                '智慧合約風險。合約經過審查、形式化分析與原始碼驗證，但這些都不構成保證；任何持有價值的軟體都可能存在未知缺陷。',
                ...
                '資產波動。ETH、CST 與 NFT 的價值都會波動。參與需要花費真金白銀，應把落筆當作為參與和藝術付出的花費，而非取得金錢的途徑。',
    ...
    conclusion: {
      ...
      blocks: [
        {
          kind: 'paragraph',
          text: 'Cosmic Signature 想要建成這樣一個生成藝術協議：不需要任何人的許可，最終也不需要任何人的照看。機制小到可以完整寫清：價格遞減的窗口、落筆不斷延長的倒數、固定的分配比例、滾動累積的儲備，以及一門只由物理和種子決定的藝術。剩下的升級屈指可數，且全部公開。待它們完成，所有者角色退場，留下的正是本文所寫的一切：一座時鐘、一份儲備、一枚代幣、一個議會，以及一幅接一幅、記錄著每雙塑造之手的簽名。',
        },
      ],
    },
    'appendix-a': {
      ...
      blocks: [
        {
          ...
          table: {
            ...
            rows: [
              ...
              ['落筆訊息長度上限', `${protocolFacts.gestureMessageMaxLength} 位元組`],
              [
                'ETH 分配軌道',
                `簽名 ${protocolFacts.mainEthPercentage}%、時之勇士 ${protocolFacts.chronoWarriorEthPercentage}%、公共財 ${protocolFacts.publicGoodsPercentage}%、錨定配發 ${protocolFacts.anchorDistributionPercentage}%、ETH 星選 ${protocolFacts.stellarSelectionEthPercentage}%`,
              ],
  ...
  references: {
    ...
    items: [
      {
        label: 'Cosmic Signature 合約儲存庫（原始碼、測試與驗證工具）',
        href: 'https://github.com/PredictionExplorer/Cosmic-Signature',
      },
      {
        label: 'Cosmic Signature 應用程式',
        href: 'https://app.cosmicsignature.com/zh-TW',
      },
      {
        label: 'Cosmic Signature 協議站點',
        href: 'https://cosmicsignature.com/zh-TW',
      },
      {
      ...
      {
        label: 'Protocol Guild 文件',
        href: 'https://protocol-guild.readthedocs.io',
      },
      {
        label: 'OpenZeppelin Governor 文件',
  ...
  licenseNote: '本文與 Cosmic Signature 全部專案自有材料一樣，依 CC0 1.0 獻入公有領域。',
  reading: {
    railLabel: '本頁目錄',
  ...
  figures: {
    cycle: {
      title: '一個演繹週期：從開場到下一週期',
      caption: '時長為上線參數；具體規則見第 3 節。',
      steps: [
        {
          label: '開場',
          detail: 'ETH 校準窗口逐步壓低開場價格，直到有人落下第一筆。',
        },
        {
          label: '落筆',
