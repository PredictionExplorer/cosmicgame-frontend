...
| `type-eyebrow`                 | 12px           | 16px | 500    | Inter | Section and page kicker, once per section. Uppercase with 0.12em tracking (0.08em on phones); CJK: 13px with no case and no tracking |
