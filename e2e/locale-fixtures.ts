...
export const LOCALE_ROUTE_TEXT: Record<TranslatedLocale, Readonly<Record<string, string>>> = {
  ...
  'zh-TW': {
    ...
    'allocation-finalized': `第 ${cycle} 個週期的分配`,
    anchoring: '錨定配發',
    'anchor-action': '錨定操作',
    'my-allocations': '我的分配',
    'my-anchors': '我的錨定',
  ...
  uk: {
    ...
    'allocation-finalized': `Розподіли циклу ${cycle}`,
  ...
  ko: {
    ...
    'allocation-finalized': `사이클 ${cycle} 배분`,
    anchoring: '앵커링 지급',
  ...
  ja: {
    ...
    'allocation-finalized': `サイクル${cycle}の配分`,
    anchoring: '係留配分',
    'anchor-action': '係留操作',
  ...
  vi: {
    ...
    'allocation-finalized': `Phân bổ chu kỳ ${cycle}`,
