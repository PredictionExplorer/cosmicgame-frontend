...
export const LOCALE_ROUTE_TEXT: Record<TranslatedLocale, Readonly<Record<string, string>>> = {
  ...
  vi: {
    ...
    'signature-transfer-history': 'Chuyển giao Cosmic Signature',
    'cst-transfer-history': 'Chuyển token CST của Cosmic Signature',
    ...
    'outreach-address': 'Phân bổ truyền thông của người dùng',
