...
const appIndexableRoutes: SeoRoute[] = [
  ...
  ['/statistics/participation', 'data', 'daily', 0.7],
  ['/statistics/tokens', 'data', 'daily', 0.7],
  ['/statistics/anchoring', 'data', 'daily', 0.7],
  ['/statistics/activity', 'data', 'daily', 0.7],
  ['/statistics/performance', 'data', 'daily', 0.7],
