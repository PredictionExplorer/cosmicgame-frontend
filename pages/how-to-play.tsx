  ...
  return (
    <>
      ...
      <MainWrapper>
        ...
        <Typography mb={2}>
          Cosmic Signature is a strategy bidding game. In an exhilarating
          contest, players will bid against other players and against time to
          win exciting $ETH prizes and Cosmic Signature NFTs.
        </Typography>
        <Typography mb={4}>
        ...
        <Box mt={8}>
          ...
          <Typography mb={2}>
            ...
            ), you will be automatically prompted to connect your crypto wallet
            to the website.
          </Typography>
          <Typography mb={4}>
            If you are not prompted, click the [Connect Wallet] button at the
            top of your homepage screen.
          </Typography>
          <Box mb={4}>
        ...
        <Box mt={8}>
          ...
          <Typography mb={4}>
            1. <b>[Round Timer]:</b> At the top left of the website, you will
            see a countdown timer ticking down. At the start of each round, this
            timer is reset to 24 hours. Every time someone places a bid, the
            timer adds 1 hour. The last person to bid when the timer runs out
            wins the game.
          </Typography>
          <Box mb={4}>
          ...
          <Typography mb={4}>
            If you hold an NFT from our sister collection Random Walk NFT, you
            can get a 50% discount on your $ETH bid price. However, keep in mind
            that you can avail the 50% discount once, so be wise about using it.
          </Typography>
          <Box mb={4}>
          ...
          <Typography mb={2}>
            4. <b>[Last Bidder Address]:</b> The wallet address of the last
            person that made a bid.
          </Typography>
          <Typography mb={2}>
        ...
        <Box mt={8}>
          ...
          <Typography mb={2}>
            If you wish to avail your 50% Random Walk NFT discount, click
            [Random Walk].
          </Typography>
          <Typography mb={2}>
          ...
          <Typography mb={2}>
            Review this price and when you want to make a bid, click the [Bid
            Now] button.
          </Typography>
          <Typography mb={2}>
            As soon as you click this button, you will be prompted to your
            wallet and asked to confirm the transaction.
          </Typography>
          <Typography mb={2}>
            Make sure to review your transaction before signing it. Also check
            the gas fees, and then approve the transaction.
          </Typography>
          <Typography mb={2}>
            When you make a bid, the countdown timer will increase by 1 hour,
            and the next bid price will increase by 1%. When the timer reaches
            zero, the last player to make the bid will win the round.
          </Typography>
        </Box>
        <Box mt={8}>
          <Accordion expanded={expanded === 0} onChange={handleChange(0)}>
            ...
            <AccordionDetails>
              ...
              <Typography mb={2}>
                When you win, you get 25% of the prize pool. You will be
                required to withdraw this prize money from a special contract.
              </Typography>
              <Typography mb={2}>
              ...
              <ul>
                <li>
                  <Typography>
                    ...
                    <b>[Current Round Bid History]</b> at the end of the
                    homepage.
                  </Typography>
                </li>
                <li>
